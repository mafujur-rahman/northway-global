          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff9100] focus:border-transparent text-gray-900 placeholder-gray-400"
