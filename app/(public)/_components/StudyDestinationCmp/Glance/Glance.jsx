...
export default function AtAGlance ({ colorText = 'Usa' , glanceData }) {
  return (
    <div className='section__spacing '>
      ...
      <div className='bg-[#FFF9F3] rounded-lg p-2.5 md:p-5 lg:p-10 mt-10 '>
        ...
        {glanceData.map(item => (
          ...
          >
            <h4 className='font-semibold text-sm sm:text-base md:text-lg text-gray-800 mb-2 col-span-2'>
              {item.factor}
            </h4>
            <ul className='list-none text-sm sm:text-base md:text-lg text-gray-600 space-y-1 col-span-4 '>
