            ...
            <div className='flex flex-row items-stretch gap-2 justify-start 2xl:justify-center'>
              ...
              {applicationProcess.map((step, index) => (
                <React.Fragment key={step.id}>
                  {/* Card */}
                  <div className='flex-shrink-0 w-[150px] 2xl:w-[180px]'>
                    <div className='bg-white rounded-xl px-4 py-4 text-center h-full flex flex-col shadow-sm hover:shadow-md transition-shadow'>
                      <div
                        className={`flex items-center justify-center w-14 h-14 mx-auto rounded-full border-2 border-dashed mb-3 ${
                          step.id === 1
                            ? 'bg-white text-[#ff9100] border-[#ff9100] overflow-hidden p-1'
                            : step.highlight
              ...
              <div className='w-full max-w-[280px]'>
                <div className='bg-white rounded-xl p-3 text-center shadow-sm'>
                  <div
                    className={`flex items-center justify-center w-14 h-14 mx-auto rounded-full border-2 border-dashed mb-3 ${
                      step.id === 1
                        ? 'bg-white border-[#ff9100] overflow-hidden p-1'
                        : step.highlight
                        ? 'bg-[#ff9100]/10 text-[#ff9100] border-[#ff9100]'
