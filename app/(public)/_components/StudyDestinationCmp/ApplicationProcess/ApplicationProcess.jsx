  ...
  return (
    <section className='section__spacing'>
      <div className='container mx-auto px-4'>
        ...
        {/* Desktop View - Cardwise with arrows */}
        <div className='hidden md:flex flex-wrap justify-center items-center gap-1'>
          {applicationProcess.map((step, index) => (
            <React.Fragment key={step.id}>
              ...
              {/* Arrow between cards - larger size */}
              {index < applicationProcess.length - 1 && (
                <div className='flex-shrink-0'>
                  <FaArrowRight className='text-[#ff9100] text-3xl md:text-4xl font-bold mx-1' />
                </div>
              )}
            </React.Fragment>
          ))}
        ...
        {/* Mobile view with cards and vertical arrows */}
