...
export default function page () {
  const studyAbroadData = [
    {
      id: 1,
      tooltipText: ' Study In Malaysia',
      image:
        'https://pub-5955669eccb64965b91474a798f31ae3.r2.dev/uk/whyStudy.jpg',
      title: 'Why Study  ',
      colorText: 'in Malaysia ?',
      description:
        'Malaysia is home to some of the world’s most prestigious universities. Institutions like Oxford, Cambridge, Sorbonne, and ETH Zurich offer education at the highest standards, and degrees from these universities are highly regarded worldwide.',
      ...
      quickFacts: [
        ...
        { id: 4, text: 'International branch campuses (UK/Australia universities)' },
        { id: 4, text: 'Affordable tuition & living costs' },
  ...
  const educationCostData = [
    {
      ...
      colorText: 'Education',
      description:
        'In Malaysia, tuition fees vary based on the state, the university funding model, and the student’s country of origin. So, listing an average is a rather difficult task. However, thanks to the folks at College Board, they’ve rendered an estimate of last year’saverage tuition costs, which will roughly reflect the next few years.',
      quickFactsTitle: 'Quick Facts',
      quickFacts: [
        { id: 1, text: 'Total Expenses: 34100 RM (BDT-10,57,100)' },
        { id: 2, text: 'Tuition Fees for one-year (Indicative):15,000 RM (BDT-4,65,000).' },
        { id: 3, text: 'Living and Accommodation:18,000 RM (BDT-5,58,000)' },
        { id: 4, text: 'Airfare from Bangladesh to Malaysia: RM 750 (BDT-23,250)' },
        { id: 5, text: 'Visa Fees: RM 350 (BDT-10,850)' }
      ]
    }
  ]
  ...
  const glanceData = [
    {
      ...
      value: [
        "Vocational or Diploma courses - RM 15,000 (BDT-4,65,000) approximately",
        "Bachelor's degree - RM 15,000 (BDT-4,65,000) approximately",
        "Master's degree - RM 15,000(BDT-4,65,000) approximately",
        'MS - RM 15,000–RM 140,000 (BDT-4,65,000- 43,40,000) approximately',
        'Ph.D. - RM 15,000–RM 150,000 (BDT-4,65,000- 46,50,000) approximately'
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      value: [
        'RM 375 (BDT-10,850) approximately',
        'RM 187.50 (BDT-5812) approximately for minors (less than 18 years old)',
      ]
    }
  ]
  ...
  const faqsData = [
    {
      title: 'How much of a gap is accepted for study in the Malaysia?',
      description:
        'The gap accepted to study in the Malaysia depends on the level of education a candidate is pursuing. Typically, a gap of up to 2 years is acceptable for undergraduate programs, whereas a gap of almost 5 years is accepted for candidates aspiring to study for a postgraduate degree in the Malaysia.'
    },
    {
      title: 'How much money is required to study in the Malaysia?',
      description:
    ...
    {
      title: 'How to get a scholarship to study in the Malaysia?',
      description:
        'A plethora of funding options is available to study in the Malaysia. Candidates must check the official websites of Malaysia universities and educational institutions, as well as government and private organizations, for scholarship opportunities. Widely, a tremendous academic record can help candidates in securing scholarships in the Malaysia.'
    },
    {
      title: 'How to study in the Malaysia from Bangladesh?',
      description:
        'From researching for a course to arranging for accommodation, candidates need to follow key steps as listed below to study in the Malaysia. Selecting a course and university Meeting the admission requirements to get an acceptance letterAttaining a student visa to stay and study in the MalaysiaLearning about pre and post-departure processes'
    }
  ]
    ...
    <div>
      <div>
        <Banner
          ...
          des='Malaysia is home to some of the world’s most prestigious universities. Institutions like Oxford, Cambridge, Sorbonne, and ETH Zurich offer education at the highest standards, and degrees from these universities are highly regarded worldwide.'
        />
      </div>
      <ApplicationProcess />
      ...
      <AtAGlance glanceData={glanceData} colorText='Malaysia' />
      {/* <StudentSpeaks /> */}
      <Testimonial />
      <FaqArea
        faqsData={faqsData}
        countryName='Malaysia'
        des='Studying in the Malaysia can offer a variety of benefits, making it an attractive destination for international students. Here are some reasons why study in Malaysia is a popular choice.'
      />
      <BlogList />
    </div>
  )
