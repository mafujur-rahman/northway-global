...
export default function page () {
  const studyAbroadData = [
    {
      ...
      quickFacts: [
        ...
        { id: 4, text: 'Fast admission process' }
      ]
    }
  ]
  const educationCostData = [
    {
      ...
      quickFactsTitle: 'Quick Facts',
      quickFacts: [
        { id: 1, text: 'Total Expenses: 28302 GBP (BDT-46,98,132)' },
        { id: 2, text: 'Tuition Fees for one-year (Indicative): 16,000 GBP (BDT-26,56,000)' },
        { id: 3, text: 'Living and Accommodation: 12,000-18,000 GBP (BDT-19,92,000- 29,88,000) (Per year)' },
        { id: 4, text: 'Airfare from Bangladesh to UK:  75,000 BDT' },
        { id: 5, text: 'Visa Fees: 524 GBP (BDT-86,984)' }
      ]
    }
  ]
  ...
  const glanceData = [
    {
      ...
      value: [
        "Bachelor's and Master's degrees - GBP 10,000 - GBP 40,000 (BDT-16,60,000 to BDT-41,62,000 approximately)",
        'Ph.D. - Up to GBP 20,000 (BDT-33,20,000 approximately)'
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      value: [
        'GBP 524 (BDT-86,984 approximately) for Tier 4 (General) student visa'
      ]
    }
  ]
  ...
  const faqsData = [
    ...
    {
      title: 'How to study in the UK from Bangladesh?',
      description:
