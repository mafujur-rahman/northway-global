...
export default function page () {
  const studyAbroadData = [
    {
      id: 1,
      tooltipText: ' Study In China',
      image:
        'https://pub-5955669eccb64965b91474a798f31ae3.r2.dev/uk/whyStudy.jpg',
      title: 'Why Study  ',
      colorText: 'in China ?',
      description:
        'China is home to some of the world’s most prestigious universities. Institutions like Oxford, Cambridge, Sorbonne, and ETH Zurich offer education at the highest standards, and degrees from these universities are highly regarded worldwide.',
      ...
      quickFacts: [
        ...
        { id: 4, text: 'Modern campuses & facilities' },
        { id: 4, text: 'Low tuition fees with scholarship opportunities' },
  ...
  const educationCostData = [
    {
      ...
      colorText: 'Education',
      description:
        'In China, tuition fees vary based on the state, the university funding model, and the student’s country of origin. So, listing an average is a rather difficult task. However, thanks to the folks at College Board, they’ve rendered an estimate of last year’saverage tuition costs, which will roughly reflect the next few years.',
      quickFactsTitle: 'Quick Facts',
      quickFacts: [
        { id: 1, text: 'Total Expenses: 53,055 RMB (BDT-9,54,990)' },
        { id: 2, text: 'Tuition Fees for one-year (Indicative): 15,000 RMB (BDT-2,70,000)' },
        { id: 3, text: 'Living and Accommodation: 36,000 RMB (BDT-6,48,000)' },
        { id: 4, text: 'Airfare from Bangladesh to China: 1500 RMB (BDT-27,000)' },
        { id: 5, text: 'Visa Fees: 555 RMB (BDT-10,000)' }
      ]
    }
  ]
  ...
  const glanceData = [
    {
      ...
      value: [
        "Vocational or Diploma courses – Tuition fee Free",
        "Bachelor's degree – 15,000 RMB (BDT-2,70,000)",
        "Master's degree - (BDT-2,70,000)",
        "Ph.D. - 20,000 RMB (BDT-3,60,000)",
      ]
    },
    {
      id: 2,
  ...
  const faqsData = [
    {
      title: 'How much of a gap is accepted for study in the China?',
      description:
        'The gap accepted to study in the China depends on the level of education a candidate is pursuing. Typically, a gap of up to 2 years is acceptable for undergraduate programs, whereas a gap of almost 5 years is accepted for candidates aspiring to study for a postgraduate degree in the China.'
    },
    {
      title: 'How much money is required to study in the China?',
      description:
    ...
    {
      title: 'How to get a scholarship to study in the China?',
      description:
        'A plethora of funding options is available to study in the China. Candidates must check the official websites of China universities and educational institutions, as well as government and private organizations, for scholarship opportunities. Widely, a tremendous academic record can help candidates in securing scholarships in the China.'
    },
    {
      title: 'How to study in the China from Bangladesh?',
      description:
        'From researching for a course to arranging for accommodation, candidates need to follow key steps as listed below to study in the China. Selecting a course and university Meeting the admission requirements to get an acceptance letterAttaining a student visa to stay and study in the ChinaLearning about pre and post-departure processes'
    }
  ]
    ...
    <div>
      <div>
        <Banner
          ...
          des='China is home to some of the world’s most prestigious universities. Institutions like Oxford, Cambridge, Sorbonne, and ETH Zurich offer education at the highest standards, and degrees from these universities are highly regarded worldwide.'
        />
      </div>
      <ApplicationProcess />
      ...
      <AtAGlance glanceData={glanceData} colorText='China' />
      {/* <StudentSpeaks /> */}
      <Testimonial />
      <FaqArea
        faqsData={faqsData}
        countryName='China'
        des='Studying in the China can offer a variety of benefits, making it an attractive destination for international students. Here are some reasons why study in China is a popular choice.'
      />
      <BlogList />
    </div>
  )
